...
const ShareArticlePageButtons = () => {
  ...
  return (
    <div className="py-2">
      <label className="block mb-2">SHARE</label>
      <div className="flex space-s-4">
        <button
          onClick={shareOnWhatsApp}
          className="p-2 text-primary bg-white border hover:shadow rounded-full transition"
        >
          <WhatsappIcon />
        </button>
        <button
...
export default ShareArticlePageButtons;
